...
#import "LXGGView.h"
@interface LXGGView2Controller ()
@property(nonatomic,strong)LXGGView *ggView;
@end

@implementation LXGGView2Controller
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"使用第三方图片选择器";
    ...
    self.ggView.isSelect3rdPicker  = YES;
    
    NSArray *array = [[NSUserDefaults standardUserDefaults]objectForKey:@"ggView2"];
...
-(void)saveAction{
    ...
    [[NSUserDefaults standardUserDefaults]setObject:dataA forKey:@"ggView2"];
